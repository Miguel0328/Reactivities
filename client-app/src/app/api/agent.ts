...
const requests = {
  ...
  post: (url: string, body: {}) =>
    axios.post(url, body).then(sleep(250)).then(responseBody),
  put: (url: string, body: {}) =>
    axios.put(url, body).then(sleep(250)).then(responseBody),
  delete: (url: string) =>
    axios.delete(url).then(sleep(250)).then(responseBody),
